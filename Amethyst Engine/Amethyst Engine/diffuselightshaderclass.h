#ifndef _DIFFUSELIGHTSHADERCLASS_H
#define _DIFFUSELIGHTSHADERCLASS_H_
...
class DiffuseLightShaderClass
{
public:
	DiffuseLightShaderClass();
	DiffuseLightShaderClass(const DiffuseLightShaderClass&);
	~DiffuseLightShaderClass();
